...
{
  protected final Log _log = Logs.getLog(getClass());
   ...
   */
  public Peer(final Stream sock, InputStream in, OutputStream out, byte[] my_id, byte[] infohash, MetaInfo metainfo)
    throws IOException
  {
    this.my_id = my_id;
    this.infohash = infohash;
    ...
    this.peerID = new PeerID(id, sock.getPeer());
    _id = __id.incrementAndGet();
