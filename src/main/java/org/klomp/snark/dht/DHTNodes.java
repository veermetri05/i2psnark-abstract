...
class DHTNodes {
    ...
    private volatile Cancellable _cleaner;
    ...
    public DHTNodes(Environment ctx, NID me) {
        _context = ctx;
        _expireTime = MAX_EXPIRE_TIME;
        _log = _context.log(DHTNodes.class);
